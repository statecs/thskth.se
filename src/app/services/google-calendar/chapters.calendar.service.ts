...
@Injectable()
export class ChaptersCalendarService extends BaseDataService<Event> {
    ...
    getCalendar(params: URLSearchParams): Observable<Event[]> {
        return this.getData(null, params)
            .map(res => Event.convertToEventType(res, ths_calendars.chapters.calendarId, this.injector.get(APP_CONFIG).EVENT_IMAGE_BASE_URL, ths_calendars.chapters.calendarName));
    }
}
